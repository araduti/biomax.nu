...
export function ProductGscBlock({
  ...
  if (!configured) {
    return (
      <fieldset className="bg-surface-alt border border-border rounded-xl p-6 md:p-8">
        <legend className="px-2 -ml-2 font-sans text-micro uppercase tracking-[0.16em] font-semibold text-ink-mute">
  ...
  return (
    <fieldset className="bg-surface-alt border border-border rounded-xl p-6 md:p-8">
      ...
      <p className="mt-3 mb-5 font-sans text-small text-ink-mute leading-relaxed">
