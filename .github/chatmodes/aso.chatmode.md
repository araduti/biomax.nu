...
# source: coreyhaines31/marketingskills@2.0.0 skill 'aso'
---
...
Score each dimension 0-10 using the criteria in `aso/references/scoring-criteria.md`.
Apply the brand maturity tier adjustments from Phase 1.5.

Reference files for platform specs and benchmarks:

- `aso/references/apple-specs.md` — Official Apple character limits, screenshot/video specs, CPP/PPO rules, rejection triggers
- `aso/references/google-play-specs.md` — Official Google Play limits, screenshot specs, Android Vitals thresholds, policies
- `aso/references/benchmarks.md` — Conversion data, rating impact, video lift, screenshot behavior, CPP/event benchmarks
...
Use the template in `aso/references/report-template.md` to structure the output.
...
- See `aso/references/apple-specs.md` for full specs, dimensions, and rejection triggers
...
- See `aso/references/google-play-specs.md` for full specs and policy details
