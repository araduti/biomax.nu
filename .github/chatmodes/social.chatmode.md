...
# source: coreyhaines31/marketingskills@2.0.0 skill 'social'
---
...
**For detailed platform strategies**: See [social/references/platforms.md](social/references/platforms.md)

**For hashtag limits and character counts**: See [social/references/platform-limits.md](social/references/platform-limits.md)
...
**For post templates and more hooks**: See [social/references/post-templates.md](social/references/post-templates.md)
...
**For the complete framework**: See [social/references/reverse-engineering.md](social/references/reverse-engineering.md)
...
**For video hook formulas and scripting templates**: See [social/references/short-form-video.md](social/references/short-form-video.md)
