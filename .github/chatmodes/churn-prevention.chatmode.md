...
# source: coreyhaines31/marketingskills@2.0.0 skill 'churn-prevention'
---
...
For detailed cancel flow patterns by industry and billing provider, see [churn-prevention/references/cancel-flow-patterns.md](churn-prevention/references/cancel-flow-patterns.md).
...
For the complete dunning playbook with provider-specific setup, see [churn-prevention/references/dunning-playbook.md](churn-prevention/references/dunning-playbook.md).
