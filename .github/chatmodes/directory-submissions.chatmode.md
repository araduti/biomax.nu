...
# source: coreyhaines31/marketingskills@2.0.0 skill 'directory-submissions'
---
...
If `.github/product-marketing.md` exists (or `.agents/product-marketing.md`, `.claude/product-marketing.md`, or the legacy `product-marketing-context.md` as fallbacks), read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
...
The full directory catalog lives in `directory-submissions/references/directory-list.md`. The positioning variant library lives in `directory-submissions/references/positioning-variations.md`. The submission tracker template lives in `directory-submissions/references/submission-tracker-template.csv`.
...
Never copy-paste the same description everywhere. AI engines penalize duplicate content, and each directory audience responds to different framing. See `directory-submissions/references/positioning-variations.md` for the full variant library. Short version:
...
Full catalog in `directory-submissions/references/directory-list.md`. Summary:
...
For each tier, prep a distinct description variant (pulled from `directory-submissions/references/positioning-variations.md`):
...
Set up the tracker spreadsheet (`directory-submissions/references/submission-tracker-template.csv`). Work left-to-right through it. 2–3 hours per batch is realistic.
...
5. **Positioning variants** — the actual copy per tier (from `directory-submissions/references/positioning-variations.md`)
...
9. **Tracker** — link to or include the CSV from `directory-submissions/references/submission-tracker-template.csv`
