...
# source: coreyhaines31/marketingskills@2.0.0 skill 'competitor-profiling'
---
...
If `.github/product-marketing.md` exists (or `.agents/product-marketing.md`, `.claude/product-marketing.md`, or the legacy `product-marketing-context.md` as fallbacks), read it before asking questions. Use that context and only ask for information not already covered.
...
Use DataForSEO MCP tools to gather quantitative competitive intelligence. Save each raw response as JSON to `competitor-profiles/raw/<competitor-slug>/<YYYY-MM-DD>/seo/<endpoint-name>.json` before parsing it into the profile. For the full list of MCP tools used in this skill (Firecrawl + DataForSEO) and example calls, see [competitor-profiling/references/tool-reference.md](competitor-profiling/references/tool-reference.md).
...
**For the full profile and summary templates**: See [competitor-profiling/references/templates.md](competitor-profiling/references/templates.md)
