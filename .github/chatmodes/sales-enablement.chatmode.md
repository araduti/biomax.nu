...
# source: coreyhaines31/marketingskills@2.0.0 skill 'sales-enablement'
---
...
**For full slide-by-slide guidance**: See [sales-enablement/references/deck-frameworks.md](sales-enablement/references/deck-frameworks.md)
...
**For templates by use case**: See [sales-enablement/references/one-pager-templates.md](sales-enablement/references/one-pager-templates.md)
...
**For the full objection library**: See [sales-enablement/references/objection-library.md](sales-enablement/references/objection-library.md)
...
**For full script templates**: See [sales-enablement/references/demo-scripts.md](sales-enablement/references/demo-scripts.md)
