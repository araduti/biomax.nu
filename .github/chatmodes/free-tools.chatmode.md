...
# source: coreyhaines31/marketingskills@2.0.0 skill 'free-tools'
---
...
**For detailed tool types and examples**: See [free-tools/references/tool-types.md](free-tools/references/tool-types.md)
