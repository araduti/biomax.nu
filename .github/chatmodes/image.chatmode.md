...
# source: coreyhaines31/marketingskills@2.0.1 skill 'image'
---
...
For detailed prompting guides per model, see [image/references/ai-image-prompting.md](image/references/ai-image-prompting.md).
