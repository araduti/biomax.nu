...
# source: coreyhaines31/marketingskills@2.0.0 skill 'marketing-psychology'
---
...
If `.github/product-marketing.md` exists (or `.agents/product-marketing.md`, `.claude/product-marketing.md`, or the legacy `product-marketing-context.md` as fallbacks), read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
