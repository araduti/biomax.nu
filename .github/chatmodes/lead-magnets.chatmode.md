...
# source: coreyhaines31/marketingskills@2.0.0 skill 'lead-magnets'
---
...
**For detailed creation guidance per format**: See [lead-magnets/references/format-guide.md](lead-magnets/references/format-guide.md)
...
**For detailed benchmarks by format and industry**: See [lead-magnets/references/benchmarks.md](lead-magnets/references/benchmarks.md)
