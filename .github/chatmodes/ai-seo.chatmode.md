...
# source: coreyhaines31/marketingskills@2.0.1 skill 'ai-seo'
---
...
For a deep dive on how each platform selects sources and what to optimize per platform, see [ai-seo/references/platform-ranking-factors.md](ai-seo/references/platform-ranking-factors.md).
...
See [ai-seo/references/platform-ranking-factors.md](ai-seo/references/platform-ranking-factors.md) for the full robots.txt configuration.
...
For detailed templates for each block type, see [ai-seo/references/content-patterns.md](ai-seo/references/content-patterns.md).
...
For tactical guidance on SaaS product pages, blog content, comparison/alternative pages, documentation, and local/ecom (Google's emphasis on Merchant Center + Business Profile), see [ai-seo/references/content-types.md](ai-seo/references/content-types.md).
