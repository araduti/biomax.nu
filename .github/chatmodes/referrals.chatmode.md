...
# source: coreyhaines31/marketingskills@2.0.0 skill 'referrals'
---
...
**For examples and incentive sizing**: See [referrals/references/program-examples.md](referrals/references/program-examples.md)
...
**For detailed affiliate program design, commission structures, recruitment, and tools**: See [referrals/references/affiliate-programs.md](referrals/references/affiliate-programs.md)
