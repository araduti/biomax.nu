...
# source: coreyhaines31/marketingskills@2.0.0 skill 'revops'
---
...
**For complete lifecycle stage templates and SLA examples**: See [revops/references/lifecycle-definitions.md](revops/references/lifecycle-definitions.md)
...
**For detailed scoring templates and example models**: See [revops/references/scoring-models.md](revops/references/scoring-models.md)
...
**For routing decision trees and platform-specific setup**: See [revops/references/routing-rules.md](revops/references/routing-rules.md)
...
**For platform-specific workflow recipes**: See [revops/references/automation-playbooks.md](revops/references/automation-playbooks.md)
